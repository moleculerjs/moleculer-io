...
module.exports = {
  ...
  methods: {
    ...
    callAction(socket, action, params, opts, handlerItem) {
      var _this = this;
      ...
      return _asyncToGenerator(function* () {
        ...
        const ctx = Context.create(_this.broker, { name: vName + ".call" }, _this.broker.nodeID, params, opts || {});
    ...
    makeHandler: function makeHandler(handlerItem) {
      ...
      return (() => {
        var _ref = _asyncToGenerator(function* (action, params, respond) {
          ...
          try {
            let res = yield svc.callAction(this, action, params, opts, handlerItem);
